...
To obtain a summary of the MCMC sampler, BASiCS provides the ``
...
The over-dispersion parameter estimated using BASiCS shows correlation with the CV2. 
...
Previously, Kolodziejczyk _et al._ used the distance to a rolling median along the mean-variability trend to correct for this confounding factor [@Kolodziejczyk2015cell].
