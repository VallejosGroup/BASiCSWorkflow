...
We therfore need to calculate the number of molecules in 6.7 nano litre reaaction mix.
...
```{r download-chain-naive, eval = FALSE}
...
# Boxplot
boxplot(list(Naive = Test_DE.LFC0$TableDisp[ind_nochange,"Disp1"],
             Active = Test_DE.LFC0$TableDisp[ind_nochange,"Disp2"]),
        ylab = "log(over-dispersion)", outline = FALSE, log = "y")
```
