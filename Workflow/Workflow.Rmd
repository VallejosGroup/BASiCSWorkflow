...
generated for a model parameter [@Gelman2014]. Simply, it is defined as
the number of samples taken relative to the total autocorrelation.
...
We can see several genes show very low sample size for mu. We
can identify these using some functions from coda.
