...
Furthermore, `BASiCS` has been extended to perform differential mean expression and differential variability testing [@Vallejos2016a].
...
These parameters are independent of technical noise and can be used as proxy for biolgocial variability [@Vallejos2016a]. 
Similar to the mean-variability trend observed for normalized scRNA-Seq data [@Brennecke2015], the estimates for over-dispersion parameters decrease with mean expression [@Vallejos2016a].
