...
Here, we will highlight the use of gene ontology (GO) analysis to group genes that are differentially expressed between naive and activated CD4^+^ T cells.



highlight genes associated to immune activation and perform GO analysis.
