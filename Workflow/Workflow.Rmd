...
ggplot(data.frame(epsilon = epsilon.naive,
                  DM = DM)) + 
...
In the following paragraphs, we will perform differential testing between naive CD4+ T cells (from this section) and activated CD4+ T cells.
