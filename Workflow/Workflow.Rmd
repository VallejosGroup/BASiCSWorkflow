...
```{r}
ERCC.count.final <- ERCC.countmul * 0.0067
```
...
genes_select <- (Test_DE$TableMean$Mean1 > 5 & Test_DE$TableMean$Mean2 > 5)
...
low_expr <- !(Test_DE$TableMean$Mean1 < 5 & Test_DE$TableMean$Mean2 < 5)
...
We find the cytokines interleukine 2 (_Il2_) and tumor necrosis factor (_Tnf_) being up-regulated in a variable fashion. 
In the case of _Il2_, it has been proposed that this heterogeneous up-regulation supports the tuning of a robust immune response [@Fuhrmann2016]  
