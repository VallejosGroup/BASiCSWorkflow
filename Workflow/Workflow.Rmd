...
The volume per well in the IFC chip is 6.7 nano litre [https://www.fluidigm.com/faq/ifc-9](https://www.fluidigm.com/faq/ifc-9).
We therfore need to calculate the number of molecules in 6.7 nano litre reaction mix.

```{r}
ERCC.count.final <- ERCC.count * 0.0067
```
...
displayChainBASiCS(MCMC.naive, Param = "mu")[1:10,1:10]
```
