...
```{r Grun-data}
if(!file.exists("Grun_rawCounts.zip")){
  download.file("https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE54695", 
                destfile = "Grun_rawCounts.zip")
  unzip(zipfile = "Grun_rawCounts.zip", exdir = "./")
}
rawCounts <- as.matrix(fread("Grun_rawCounts.tsv", sep = "\t", header = FALSE, 
                   data.table = FALSE))
```
