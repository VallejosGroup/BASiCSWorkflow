...
The filtering is done based on the filtering strategy in the original publication (see [Sample GSM1322278](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSM1322278)).
Furthermore, samples with less than 10 transcripts of Oct4 (Pou5f1) were removed to exclude differentiating cells or samples with low sequencing efficiency.

```{r QC}
# Quality control - remove low Oct4 cells
Pou5f1.per.cell <- as.numeric(CountsUMI["Pou5f1",])

CountsUMI <- CountsUMI[,as.numeric(CountsUMI["Pou5f1",]) >= 10]
