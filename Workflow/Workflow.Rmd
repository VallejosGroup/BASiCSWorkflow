...
For convenience, we will generate a `SingleCellExperiment` [@Lun2018SCE] that contains all cells and that stores cell- and gene-specific metadata.
...
Prior to quality control, we will remove all genes that are not expressed in at least 2 cells.
