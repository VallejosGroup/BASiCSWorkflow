...
# Low ESS for delta
ess.naive.delta <- coda::effectiveSize(coda::mcmc(displayChainBASiCS(MCMC.naive, "delta")))
ind_ess.naive.delta <- ess.naive.mu > 100
ess.active.delta <- coda::effectiveSize(coda::mcmc(displayChainBASiCS(MCMC.active, "delta")))
ind_ess.active.delta <- ess.naive.mu > 100

# Genes to exclude
to_exclude <- low_expr & ind_ess.naive.mu & 
  ind_ess.active.mu & ind_ess.naive.delta & ind_ess.active.delta
```
...
immun.genes <- unique(unlist(mget(cyt.allegs, org.Mm.egENSEMBL)))
