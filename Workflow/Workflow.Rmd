...
From a data analysis perspective, the `BASiCS_MCMC` function is the heart of the `BASiCS` package and can be run in four different settings (see [Table 1](#tab:MCMC_settings)). 

: {#tab:MCMC_settings} Four settings that can be used to run the `BASiCS_MCMC` function.
