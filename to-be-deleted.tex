...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Find which spike-ins were captured through sequencing}
\NormalTok{detected_spikes <-}\StringTok{ }\KeywordTok{rowSums}\NormalTok{(}\KeywordTok{assay}\NormalTok{(}\KeywordTok{altExp}\NormalTok{(sce_naive_active, }\StringTok{"spike-ins"}\NormalTok{)) }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{) }\OperatorTok{>}\StringTok{ }\DecValTok{0}
\CommentTok{## Remove spike-ins that are not present from matrix and SCE object}
\KeywordTok{altExp}\NormalTok{(sce_naive_active, }\StringTok{"spike-ins"}\NormalTok{) <-}\StringTok{ }\KeywordTok{altExp}\NormalTok{(sce_naive_active)[detected_spikes, ]}
\end{Highlighting}
\end{Shaded}
