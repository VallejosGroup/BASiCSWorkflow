...
{\centering \includegraphics{figure/visualise-MA-plot-1} 
...
{\centering \includegraphics{figure/visualise-volcano-plot-1} 
...
\NormalTok{Test_DE <-}\StringTok{ }\KeywordTok{BASiCS_TestDE}\NormalTok{(}
  \DataTypeTok{Chain1 =}\NormalTok{ chain_naive,}
  \DataTypeTok{Chain2 =}\NormalTok{ chain_active,}
  \DataTypeTok{EpsilonM =} \KeywordTok{log2}\NormalTok{(}\DecValTok{2}\NormalTok{),}
  \DataTypeTok{GroupLabel1 =} \StringTok{"Naive"}\NormalTok{,}
  \DataTypeTok{GroupLabel2 =} \StringTok{"Active"}\NormalTok{,}
  \DataTypeTok{Plot =} \OtherTok{FALSE}\NormalTok{,}
  \DataTypeTok{PlotOffset =} \OtherTok{FALSE}\NormalTok{,}
...
\NormalTok{)}
\NormalTok{TableMean <-}\StringTok{ }\KeywordTok{format}\NormalTok{(Test_DE, }\DataTypeTok{Which =} \StringTok{"Mean"}\NormalTok{, }\DataTypeTok{Filter =} \OtherTok{FALSE}\NormalTok{)}
\NormalTok{TableDisp <-}\StringTok{ }\KeywordTok{format}\NormalTok{(Test_DE, }\DataTypeTok{Which =} \StringTok{"Disp"}\NormalTok{, }\DataTypeTok{Filter =} \OtherTok{FALSE}\NormalTok{)}
\KeywordTok{table}\NormalTok{(TableMean}\OperatorTok{$}\NormalTok{ResultDiffMean)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ind_cd <-}\StringTok{ }\NormalTok{genenames}\OperatorTok{$}\NormalTok{external_gene_name }\OperatorTok{==}\StringTok{ "Cd69"}
...
{\centering \includegraphics{figure/violin-plots-1} 
...
{\centering \includegraphics{figure/pca-cd69-1} 
