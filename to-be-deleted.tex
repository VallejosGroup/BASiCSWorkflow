...
As an initial step, we remove lowly expressed genes whose expression was
largely not detected through sequencing.
More specifically, we exclude genes whose expression was detected in less than
2 cells and those for which their average read count is below 1.
...
\emph{\href{https://bioconductor.org/packages/3.11/SimpleSingleCell}{SimpleSingleCell}} Bioconductor workflow \citep{Lun2016}.
