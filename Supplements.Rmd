...
Prior to running the MCMC, we want to control for outlying cells and 
potential heterogeneous substructure in both cell populations. 

In particular, we note that the authors identified some sub-structure within
pre-somitic mesoderm cells

```{r table-subclusters}

table(cluster_labels$cell)
```
