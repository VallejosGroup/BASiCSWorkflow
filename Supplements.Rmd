...
DropletTableDisp <- as.data.frame(Droplet_Test_logFC0, Parameter = "Disp", Filter = FALSE)
...
Droplet_TableMean <- as.data.frame(Droplet_Test, Parameter = "Mean", Filter = FALSE)
```
...
Droplet_TableResDisp <- as.data.frame(Droplet_Test, Parameter = "ResDisp", Filter = FALSE)
