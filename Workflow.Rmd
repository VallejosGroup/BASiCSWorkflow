...
rowData(sce_sm) <- merge(rowData(sce_sm), vg_table, 
...
assay(sce_sm, "BASiCS_norm") <- BASiCS_DenoisedCounts(sce_sm, chain_sm)

## Select HVG/LVG genes with similar mean expression values
low_exp <- 20; up_exp <- 40
...
plot_hvg <- plotExpression(sce_sm, 
               ...
               feature_colours = FALSE) + ylim(0, 90) 

plot_lvg <- plotExpression(sce_sm, 
