...
of most differential expression tools).  then to compare expression 
profiles between the clusters [@Lahnemann2020]). 
...
Due to typical inverse relationship
, 
proposed 


However, the strong relationship that is typically observed between variability and mean estimates (e.g., Brennecke et al. [2013]) can hinder the interpretation of these results.


[SAY SOMETHING ABOUT THE CONFOUNDING]. 
This limitation was addressed by @Eling2018. 

<!---
PLACE-HOLDER FOR TEXT THAT MAY BE USEFUL.

@Eling2018 introduced a novel method of inferring gene expression profiles 
using `r Biocpkg("BASiCS")` without
