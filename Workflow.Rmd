...
The negative binomial framework we use is commonly used to model count
data with more complex variability patterns than a simple Poisson model,
and has been used broadly for bulk sequencing data [@Roberts2009;@Love2014]
...
@Love2014 and others, where sparse data is pooled to provide more reliable
estimates.
