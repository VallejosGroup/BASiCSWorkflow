...
`BASiCS_DetectLVG` to select genes with substiantilly large or small 
transcriptional variability within a population of cells (see *Methods*). 
If the `BASiCS_MCMC` sampler was run with `Regression = TRUE`,
