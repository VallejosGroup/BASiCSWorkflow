...
in the supplementary material (see Section [ADD-REF]). For simplicity, we will 
proceed by loading this pre-processed data for the current analysis.
Separate `SingleCellExperiment` data objects were generated for presomitic and 
somitic mesoderm cells, as `r Biocpkg("BASiCS")` will be applied separately to 
group of cells. 
