...
```{r residual-vs-mean, fig.width=4, fig.height=5, fig.cap="Residual over-dispersion estimates obtained by BASiCS are plotted against mean expression (log-scale) for naive cells. Colour represents local density, with lighter colours representing higher density. Genes that are not observed to be expressed in at least 2 cells within each group are excluded."}
...
ind_not_na <- !(is.na(parameter_df$eps_naive))

ggplot(parameter_df[ind_not_na, ]) +
...
```{r delta-var, fig.width=4, fig.height=5, fig.cap="Over-dispersion estimates obtained by BASiCS are plotted against variance of scran-normalised counts for naive cells on a log-log scale. Colour represents local density, with lighter colours representing higher density. Genes that are not observed to be expressed in at least 2 cells within each group are excluded."}
ggplot(parameter_df[ind_not_na, ]) +
...
```{r delta-cv2, fig.width=4, fig.height=5, fig.cap="CV2 estimates from normalised counts are plotted against over-dispersion estimates obtained by BASiCS for naive cells on a log-log scale. Colour represents local density, with lighter colours representing higher density. Genes that are not observed to be expressed in at least 2 cells within each group are excluded."}
ggplot(parameter_df[ind_not_na, ]) +
...
```{r mean-dm, fig.width=4, fig.height=5, fig.cap="DM estimates obtained using scran are plotted against mean expression (log-scale) for naive cells. Colour represents local density, with lighter colours representing higher density. Genes that are not observed to be expressed in at least 2 cells within each group are excluded."}
ggplot(parameter_df[ind_not_na, ]) +
...
```{r eps-dm, fig.width=4, fig.height=5, fig.cap = "Residual over-dispersion estimates obtained using BASiCS are plotted against DM estimates for naive cells. Colour represents local density, with lighter colours representing higher density. Genes that are not observed to be expressed in at least 2 cells within each group are excluded."}
ggplot(parameter_df[ind_not_na, ]) +
