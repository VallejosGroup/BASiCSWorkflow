...
of the results, and to identify systematic patterns among the genes identified. One useful
way to do this is by examining the normalised counts on a
gene-by-gene basis.
...
respectively). These are genes with higher variability in one population and differing levels of detection; as mentioned above,
