...
sce_naive_active <- sce_naive_active[rowSums(counts(sce_naive_active)) > 0, ]
# Remove genes
...
ggplot() +
  geom_point(
    aes(
      rowSums(counts(sce_naive_active) > 0),
      rowMeans(counts(sce_naive_active)),
      colour = ifelse(ind_expressed, "Retained", "Removed")
    )
  ) +
  geom_vline(xintercept = 5, linetype = "dashed", col = "grey60") +
  geom_hline(yintercept = 1, linetype = "dashed", col = "grey60") +
  scale_colour_brewer(palette = "Set1", name = NULL) +
  labs(x = "Fraction of cells observed", y = "Average count") +
