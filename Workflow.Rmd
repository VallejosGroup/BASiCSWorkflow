...
```{r ERCC, fig.height=3, fig.width=3, fig.cap="The number of spike-in counts per cells is plotted against the number of endogeneous counts per cell. Dashed lines indicates the minimum and maximum levels of endogenous counts, outside which cells are removed.", fig.pos='h', eval = FALSE}
min_reads <- 600000
max_reads <- 2300000
