...
For the naive CD4$^+$T data, we obtained *`r sum(HVG_Table$HVG, na.rm=TRUE)`* 
...
<!--- CV: EDIT FIGURE CAPTION + SIZE ---> 

```{r plot-example-vg-naive, fig.cap = "TBC"}
...
my_plot_vg(DC_naive, HVG_Table, LVG_Table, low.exp = 2, up.exp = 2.2)
```
